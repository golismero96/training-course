...
class _HomePageState extends State<HomePage> {
  ...
  void customInitialState() {
    var venturesFake = VenturesRender();
    var pageViewFake = SendRequestPageView();
    var specialofferFake = SendRequestSpecialOffer();
    var eventsFake = SendRequestEvents();

    setState(() {
      venturesFuture = venturesFake;
      pageViewFuture = pageViewFake;
      specialofferFuture = specialofferFake;
      eventsFuture = eventsFake;
    });
  }
